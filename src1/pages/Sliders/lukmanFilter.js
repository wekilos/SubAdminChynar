    ...
    return(
        <div className='lukman-gozleg'>
            <form className='lukman-gozleg--form'>
                ...
                <h2 style={{margin:"10px 10px"}}>Admin Slider page</h2>
                </div>
                <div>
                {true && <Button onClick={()=>GoshButton()} shape='round' type='primary' icon={<PlusCircleFilled />} className='lukman-gozleg--button'>Slider goş</Button> }
