...
const LukmanTable = (props)=>{
    ...
    const columns = width>850 ? [
        ...
        
        {
            ...
            render:(text,record)=>(
                <div>
                    {record.Status && dil==="TM"?record.Status.name_tm:record.Status.name_ru} 
                </div>
            )
        },
        {
        ...
        },
        {
            ...
            render: (text, record) => (
                <div>
                     <Button style={{marginBottom:"5px",width:"145px"}} type='primary'shape='round'onClick={()=>ShowInformation(record)} > {dil==="TM"?"Goşmaça":"Дополнительная"} </Button>
                     <br></br>
                     <Popconfirm
                        title={dil==="TM"?"Haryt Gowşuryldymy?":"Товар отправлен?"}
                        onConfirm={()=>Gowshuryldy(record)} 
                        // onCancel={cancel}
                        okText={dil==="TM"?"Hawa":"Да"}
                        cancelText={dil==="TM"?"Ýok":"Нет"}
                    >
                     <Button style={{marginBottom:"5px",width:"145px"}}  type='primary'shape='round' >{dil==="TM"?"Gowşuryldy":"Доставленный"}</Button>
                    </Popconfirm>
                    <br></br>
                     <Button style={{marginRight:"45px"}} type='primary'shape='round'onClick={()=>ShowDrawer(record)} ><EditOutlined /></Button>
    ...
    :[
        ...
        },
        {
            ...
            render: (text, record) => (
                <div>
                     <Button style={{marginBottom:"5px",width:"105px"}} type='primary'shape='round'onClick={()=>ShowInformation(record)} >{dil==="TM"?"Goşmaça":"Дополнительная"}</Button>
                     <br></br>
                     <Popconfirm
                        title={dil==="TM"?"Haryt Gowşuryldymy?":"Товар отправлен?"}
                        onConfirm={()=>Gowshuryldy(record)} 
                    ...
                    >
                     <Button 
                     style={{marginBottom:"5px",width:"105px"}} type='primary'shape='round' >{dil==="TM"?"Gowşuryldy":"Доставленный"}</Button>
                    </Popconfirm><br></br>
