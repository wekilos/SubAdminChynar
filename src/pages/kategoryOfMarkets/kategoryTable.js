...
// geting all data from database with api
  ...
  const DeleteMarket = (event) => {
    axiosInstance.delete("/api/kategoryOfMarkets/delete/"+event.id).then((data)=>{
...
;    })
  ...
  const saveData = (event) => {
    ...
    setEdit(false);
      ...
      axiosInstance.patch("/api/kategoryOfMarkets/update/"+maglumat.id,{
