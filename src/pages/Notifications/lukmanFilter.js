    ...
    return(
        <div className='lukman-gozleg'>
            <form className='lukman-gozleg--form'>
                ...
                <h2 style={{margin:"10px 10px"}}>Admin Notification page</h2>
                </div>
                <div>
                <Button onClick={()=>GoshButton()} shape='round' type='primary' icon={<PlusCircleFilled />} className='lukman-gozleg--button'>Notification goş</Button> 
